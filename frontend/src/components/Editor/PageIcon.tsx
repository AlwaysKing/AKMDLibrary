...
export default function PageIcon({ icon, iconLarge, spaceSlug, pageId }: PageIconProps) {
  ...
  const updatePopupPosition = useCallback(() => {
    ...
    setPopupStyle({
      position: 'fixed',
      left: rect.left + rect.width / 2 - 204,
      top: rect.bottom + 4,
      width: '408px',
    });
  }, []);
    ...
    <div className="relative inline-block">
      ...
      {isOpen && createPortal(
        <>
          ...
          <div className="fixed bg-white border border-notion-border rounded-[10px] shadow-lg z-50 overflow-hidden" style={popupStyle}>
            {/* Header: tabs + remove */}
